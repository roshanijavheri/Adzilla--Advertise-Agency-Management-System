...
Public Class CustCrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Advy_Agency_Management_System.CustCrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCustCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CustCrystalReport = New CustCrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
