...
Public Class StaffCrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Advy_Agency_Management_System.StaffCrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStaffCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StaffCrystalReport = New StaffCrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
