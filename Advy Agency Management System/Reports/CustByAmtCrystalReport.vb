...
Public Class CustByAmtCrystalReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CustByAmtCrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Advy_Agency_Management_System.CustByAmtCrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_amtReceivable() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCustByAmtCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CustByAmtCrystalReport = New CustByAmtCrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
